@extends('layouts.app')
@section('title', 'Installation Pending')
@section('content')
<style>
...
<div class="row">
    <div class="col-12">
        <h4 class="card-title my-25">Installation Pending</h4>
    </div>
    <div class="col-12">
        @if(isset($itemStock))
        <div class="card p-0">
                ...
                <div class="bs-stepper-content p-1">
                    <form class="form-repeaters" id="form" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="policy" class="content">
                            @if(isset($itemGroupStock['inverter']))
                            ...
                            <div class="w-100 pt-1" id="item-row-0">
                                <div class="row g-1">
                                    ...
                                    <div class="col-12 col-md-3 col-lg-3 my-25 custom-input-group">
                                        @if($wiValue['project_stock_qty'] > 0)
                                        ...
                                        {{-- <input type="number" max="@if($wiValue['project_stock_qty'] > $wiValue['required_qty']){{$wiValue['required_qty']}}@else{{$wiValue['project_stock_qty']}}@endif" class="form-control add-stock" name="use_stock[]" id="use_stock" placeholder="Use Stock"> --}}
                                        <input type="number" max="{{$wiValue['project_stock_qty']}}" class="form-control add-stock" name="use_project_stock[]" id="use_stock" placeholder="Use Stock" value="{{ $wiValue['project_usage'] }}">
                                        <span class="invalid-feedback d-block" id="error_no_of_inverter" role="alert"></span>
                                        @else
                                        <input type="hidden" class="add-stock" name="use_project_stock[]">
                                        @endif
                                    </div>
                                    <div class="col-12 col-md-3 col-lg-3 my-25 custom-input-group">
                                        @if($wiValue['installer_stock_qty'] > 0)
                                        ...
                                        {{-- <input type="number" max="@if($wiValue['installer_stock_qty'] > $wiValue['required_qty']){{$wiValue['required_qty']}}@else{{$wiValue['installer_stock_qty']}}@endif" class="form-control add-stock" name="use_stock[]" id="use_stock" placeholder="Use Stock"> --}}
                                        <input type="number" max="{{$wiValue['installer_stock_qty']}}" class="form-control add-stock" name="use_installer_stock[]" value="{{ $wiValue['installer_usage'] }}" id="use_stock" placeholder="Use Stock">
                                        <span class="invalid-feedback d-block" id="error_no_of_inverter" role="alert"></span>
                                        @else
                                        <input type="hidden" class="add-stock" name="use_installer_stock[]">
                                        @endif
                                    </div>
        ...
        @else
        <div class="card p-0">
            <h3 class="my-5 py-5 text-center"><i class="fa fa-warning fa-5x"></i> <br/> Either BOM not selected or stock unavailable.</h3>
        </div>
        @endif
    </div>
</div>
