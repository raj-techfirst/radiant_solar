...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">{{ __('message.Category List') }}</h4>
       {{-- @can('category-creat')
        <a role="button" class="btn btn-sm btn-primary float-end" href="{{route('category.create')}}"><i class="fa fa-plus me-25"></i> {{ __('message.Add New') }}</a>
        @endcan--}} 
        @can('category-create')
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-transparent border-bottom">
                <h4 class="text-center mb-0" id="exampleModalTitle">{{ __('message.Add Category') }}</h4>
                ...
                <form id="form" class="form" action="javascript:void(0);" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-1 custom-input-group">
                            ...
                            <input type="text" class="form-control" name="category_name" id="category_name" placeholder="{{ __('message.Category') }} *">
...
<script type="application/javascript">
    ...
    $("#inlineModal").on("hidden.bs.modal", function(e) {
        ...
        $(".custom-error").html("");
        $("#exampleModalTitle").html("{{ __('message.Add Category') }}");
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.msg_type == "success") {
                    $("#exampleModalTitle").html("{{ __('message.Edit Category') }}");
