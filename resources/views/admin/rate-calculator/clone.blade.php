@extends('layouts.app')
@section('title', 'Clone Calculator')
...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Clone Calculator</h4>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="form" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-3 mb-1 custom-input-group">
                            ...
                            <input type="number" maxlength="10" class="form-control" name="mobile" id="mobile" placeholder="Mobile No." value="" required>
