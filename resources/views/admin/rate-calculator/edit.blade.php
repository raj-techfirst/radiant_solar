                ...
                <form id="form" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-3 mb-1 custom-input-group">
                            ...
                            <input type="number" maxlength="10" class="form-control" name="mobile" id="mobile" placeholder="Mobile No." value="{{ $rateCalculatorModel->mobile }}" required>
                        ...
                        <div class="col-12 col-md-6 col-lg-5 mb-1 custom-input-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{ $rateCalculatorModel->name }}" oninput="this.value = this.value.toUpperCase()">
                        ...
                        <div class="col-12 col-md-3 col-lg-2 mb-1 custom-input-group">
                            ...
                            <input type="number" class="form-control" name="res_pv_capacity_kw" id="res_pv_capacity_kw" placeholder="PV Capacity Kw" value="{{ $rateCalculatorModel->pv_capacity_kw }}" readonly>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12 mt-2">
                            <div class="w-100 mb-2">
                                ...
                                <input type="text" class="form-control" name="remarks" id="remarks" placeholder="If Any" value="{{ $rateCalculatorModel->remarks }}">
                            </div>
...
<script type="application/javascript">
    ...
    function otherAddItemRow() {
        ...
        const rowHTML = `<tr class="item-row" data-row-index="${rowIndex}" data-row-special="" data-row-autoKw="">
                ...
                <td><input type="text" id="otherwpk-${rowIndex}" name="wpk[]" class="form-control" value="0" oninput="calculateTotalOther(${rowIndex})"></td>
    ...
    $(document).on('click', '.save', function() {
        if ($("#form").valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('rate-calculator.update',$rateCalculatorModel->id)}}",
                data: formData,
                dataType: 'json',
                cache: false,
                contentType: false,
    ...
    function perLoad() {
        rowCount = 0;
        otherrowCount = 0;
        let id = "{{$rateCalculatorModel->id}}";
        $.ajax({
            type: "POST",
            url: "{{route('get-rate-calc-data')}}",
            data: {
                "id": id,
                "_token": "{{ csrf_token() }}",
            },
            ...
            success: function(response) {
                ...
                response.data.otheritemsOriginal.forEach(item => {
                    ...
                    otherrowHTML += `<tr class="other-item-row" data-row-index="${otherrowIndex}" data-row-special="${item.is_special}" data-row-autoKw="${item.is_auto_kw}">
                            ...
                            <input type="hidden" name="category[]" value="${item.category}" />
                                ...
                                <td><input type="text" id="otherwpk-${otherrowIndex}" name="wpk[]" class="form-control" value="${item.wpk}" oninput="calculateTotalOther(${otherrowIndex})"></td>
                ...
                response.data.salesitems.forEach(item => {
                    let salerowIndex = 90001;
                    const salerowHTML = `<tr class="sale-item-row" data-row-index="${salerowIndex}" data-row-special="" data-row-autoKw="1">
                                ...
                                <td colspan="3"><input type="text" id="saleitem-${salerowIndex}" name="item[]" class="form-control" value="${item.item}"></td>               
                                <td><input type="number" id="saleqty-${salerowIndex}" name="qty[]" class="form-control" value="${item.qty}" oninput="calculateTotalSale(${salerowIndex},1)"></td>
                                <td><input type="number" id="salerate-${salerowIndex}" name="rate[]" class="form-control text-end" value="${item.rate}" oninput="calculateTotalSale(${salerowIndex},1)"></td>
                                ...
                                <td><input type="number" id="saletaxRate-${salerowIndex}" name="taxRate[]" class="form-control text-end" value="${item.taxRate}" oninput="calculateTotalSale(${salerowIndex},1)"></td>
                ...
                response.data.itemsOriginal.forEach(item => {
                    ...
                    rowHTML += `<tr class="item-row" data-row-index="${rowIndex}" data-row-special="${item.is_special}" data-row-autoKw="${item.is_auto_kw}">
                        ...
                        <td><input type="text" id="wpk-${rowIndex}" name="wpk[]" class="form-control" value="${item.wpk}" oninput="calculateTotal(${rowIndex})"></td>
