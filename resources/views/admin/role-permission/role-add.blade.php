...
<div class="row">
    <div class="col-12">
        <h4 class="content-header-title float-start">Create New Role</h4>
                ...
                <form id="form" class="form p-0 " action="javascript:void(0);" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group custom-input-group mb-1">
                            ...
                            <input type="text" class="form-control" name="name" id="name" autocomplete="off" placeholder="Enter role name">
                        ...
                        <div class="col-12 col-lg-12 my-25">
                            <h2>{{$value->type}}</h2>
                        </div>
                        @endif
                        ...
                        <div class="col-12 col-sm-3 col-md-3 col-lg-2 my-25">
                            <div class="d-flex">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label text-nowrap" for="permission{{$value->id}}"> {{$value->title}} </label>
                                </div>
                                <span class="invalid-feedback d-block" id="error_permission" role="alert"></span>
                            </div>
                        </div>
                        @php $no++; @endphp
                        @if($no % 4 == 0)
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 pt-1 text-end">
                            <button type="button" class="btn btn-sm btn-primary save">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
