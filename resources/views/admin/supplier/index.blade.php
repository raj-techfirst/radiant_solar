...
<div class="row">
    <div class="col-12 mb-50">
        <h4 class="content-header-title float-start">Supplier List</h4>
        @can('supplier-create')
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-transparent border-bottom">
                <h4 class="text-center mb-0" id="exampleModalTitle">Add Supplier</h4>
                ...
                <form id="form" class="form" action="javascript:void(0);" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 mb-1 custom-input-group">
                            ...
                            <input type="number" maxlength="10" class="form-control number" name="mobile" id="mobile" placeholder="Supplier Mobile Number">
                            <span class="invalid-feedback d-block" id="error_mobile" role="alert"></span>
                        </div>

                        <div class="col-12 col-md-6 col-lg-4 mb-1 custom-input-group">
                            <label class="form-label" for="alt_mobile">Alt. Mobile No.</label>
                            <input type="number" maxlength="10" class="form-control number" name="alt_mobile" id="alt_mobile" placeholder="Alt. Mobile No.">
                        </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-6 mb-1 custom-input-group">
                            <label class="form-label" for="payment_condition">Payment Conditions<span class="text-danger"></span></label>
                            <textarea class="form-control" name="payment_condition" id="payment_condition" placeholder="Type here.."></textarea>
                        </div>
...
<script type="application/javascript">
    ...
    $("#inlineModal").on("hidden.bs.modal", function(e) {
        ...
        $("#exampleModalTitle").html("Add Supplier");
    });

    $(document).on('click', '.edit', function() {
        var id = $(this).data('id');
        var url = "{{route('supplier.edit','id')}}".replace('id', id);
        $.ajax({
            type: "GET",
            url: url,
            dataType: 'json',
            ...
            success: function(data) {
                if (data.msg_type == "success") {
                    $("#exampleModalTitle").html("Edit Supplier");
                    $("#name").val(data.result.name);
                    $("#mobile").val(data.result.mobile);
                    $("#alt_mobile").val(data.result.alt_mobile);
                    $("#email").val(data.result.email);
                    $("#gst_number").val(data.result.gst_number);
                    $("#address").val(data.result.address);
                    $("#payment_condition").val(data.result.payment_condition);
