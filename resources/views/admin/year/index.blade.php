...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Year List</h4>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-transparent border-bottom">
                <h4 class="text-center mb-0" id="exampleModalTitle">Add Year</h4>
                ...
                <form id="form" class="form" action="javascript:void(0);" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-1 custom-input-group">
                            ...
                            <label class="form-label" for="name">Year <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="Ex. 2023-24">
...
<script type="application/javascript">
    ...
    $("#inlineModal").on("hidden.bs.modal", function(e) {
        ...
        $(".custom-error").html("");
        $("#exampleModalTitle").html("Add Year");
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.msg_type == "success") {
                    $("#exampleModalTitle").html("Edit Year");
