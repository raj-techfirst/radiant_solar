@extends('layouts.app')
@section('title', 'Meter Application Report')
@section('content')
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Meter Application Report</h4>
    </div>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('meter-application-reports')}}";
    var table = '';
    $(function() {
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            url: "{{route('meter-application-download')}}",
            type: 'POST',
            datatype: 'json',
            data: {
            ...
            success: function(data) {
                ...
                var fileName = 'Meter_Application.xlsx';
