@extends('layouts.app')
@section('title', 'Inverters Required Report')
@section('content')
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Inverters Required Report</h4>
    </div>
    <div class="col-12 mt-2">
        <div class="card p-1">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-2 custom-input-group">
                    <label class="form-label" for="inveter_company_id">Inverter Company</label>
                    <select class="form-select select2" name="inveter_company_id" id="inveter_company_id">
                        <option value="" selected>ALL Inverter Company</option>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('inverters-required-reports')}}";
    var table = '';
    $(function() {
        ...
        table = $('#table').DataTable({
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.inveter_company_id = $('#inveter_company_id').val();
                }
            },
            processing: true,
            serverSide: true,
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            url: "{{route('inverters-required-download')}}",
            type: 'POST',
            datatype: 'json',
            data: {
                "agent_sales_person_id": $('#agent_sales_person_id').val(),
                "district_id": $('#district_id').val(),
                "inveter_company_id": $('#inveter_company_id').val(),
                "_token": "{{ csrf_token() }}",
            },
            cache: false,
            xhr: function() {
            ...
            success: function(data) {
                ...
                var fileName = 'Inverter_List.xlsx';
