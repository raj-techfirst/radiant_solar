@extends('layouts.app')
@section('title', 'Dispatch List Report')
@section('content')
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Dispatch List Report</h4>
    </div>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('dispach-reports')}}";
    var table = '';
    $(function() {
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                var fileName = 'Dispatch_List.xlsx';
