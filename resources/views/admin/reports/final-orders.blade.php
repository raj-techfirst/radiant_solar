@extends('layouts.app')
@section('title', 'Final Orders Report')
@section('content')
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Final Orders Report</h4>
    </div>
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                var fileName = 'Final_Orders.xlsx';
