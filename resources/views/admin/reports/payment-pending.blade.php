@extends('layouts.app')
@section('title', 'Payment Pending Report')
@section('content')
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Payment Pending Report</h4>
    </div>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('payment-pending-reports')}}";
    var table = '';
    $(function() {
        ...
        table = $('#table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'salesquatationfull.subsidy',
                    name: 'salesquatationfull.subsidy',
                },
                {
                    data: 'net_customer_price',
                    name: 'net_customer_price',
                },
                {
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            url: "{{route('payment-pending-download')}}",
            type: 'POST',
            datatype: 'json',
            data: {
            ...
            success: function(data) {
                ...
                var fileName = 'Payment_Pending_Report.xlsx';
