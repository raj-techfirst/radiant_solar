...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Total Collection Report</h4>
    </div>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('total-collection-reports')}}";
    var table = '';
    $(function() {
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            url: "{{route('total-collection-download')}}",
            type: 'POST',
            datatype: 'json',
            data: {
            ...
            success: function(data) {
                ...
                var fileName = 'Total_Collection.xlsx';
