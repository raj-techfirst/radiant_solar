@extends('layouts.app')
@section('title', 'Subsidy Claim Report')
@section('content')
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Subsidy Claim Report</h4>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-2 custom-input-group">
                    ...
                    <select class="form-select select2" name="status" id="status">
                        ...
                        <option value="subsidy_claimed">Subsidy Request</option>
                        <option value="subsidy_receveid">Subsidy Disbursal</option>
                        <!-- <option value="file_cancel_order">File Cancel Order</option> -->
                    </select>
                </div>
                <div class="col-sm-12 col-md-3 col-lg-2 custom-input-group">
                ...
                <table id="table" class="datatables-basic table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Subsidy Request Date</th>
                            <th>Subsidy Verify Date</th>
                            <th>Subsidy Disbursal Date</th>
                            <th>Invoice No</th>
                            <th>Date</th>
                            <th>Agent</th>
                            <th>Asign Person</th>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('subsidy-claim-reports')}}";
    var table = '';
    $(function() {
        ...
        table = $('#table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'meter_installation_date',
                    name: 'meter_installation_date'
                },
                {
                    data: 'subsidy_request_date',
                    name: 'subsidy_request_date'
                },
                {
                    data: 'subsidy_disbursement_verify_date',
                    name: 'subsidy_disbursement_verify_date'
                },
                {
                    data: 'subsidy_disbursement_date',
                    name: 'subsidy_disbursement_date'
                },
                {
                    data: 'invoice_no',
                    name: 'invoice_no'
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            url: "{{route('subsidy-claim-download')}}",
            type: 'POST',
            datatype: 'json',
            data: {
            ...
            success: function(data) {
                ...
                var fileName = 'Subsidy_Claim.xlsx';
