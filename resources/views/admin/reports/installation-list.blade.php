...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">Installation Report</h4>
    </div>
...
<script type="text/javascript">
    'use strict';
    const URL = "{{route('installation-reports')}}";
    var table = '';
    $(function() {
    ...
    $(document).on('click', '.download', function() {
        $.ajax({
            url: "{{route('installation-download')}}",
            type: 'POST',
            datatype: 'json',
            data: {
            ...
            success: function(data) {
                ...
                var fileName = 'Installation_Report.xlsx';
