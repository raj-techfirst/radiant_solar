...
<div class="row">
     <div class="col-12 mb-2">
          <h2 class="content-header-title float-start">{{ __('message.View Status') }}</h2>
          <a role="button" class="btn btn-primary float-end" href="{{route('status-master.create')}}">{{ __('message.Add Status') }}</a>
     </div>
     <div class="col-12">
          <div class="card p-2">
