...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">District List</h4>
    ...
    <div class="col-12">
        <div class="card p-1">
            <table id="district" class="datatables-basic table table-hover">
                <thead>
                    <tr>
                        <th>#</th>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-transparent border-bottom">
                <h4 class="text-center mb-0" id="exampleModalTitle">Add District</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-1 custom-input-group">
                            ...
                            <select class="form-control" name="state_id" id="state_id">
                                ...
                                <option value="{{$value->id}}" {{ (isset($city) && ($city->state_id == $value->id) ? 'selected' : '')}}>{{$value->state_name}}</option>
                                @endforeach
                        ...
                        <div class="col-12 col-md-12 mb-1 custom-input-group">
                            ...
                            <label class="form-label" for="name">District<span class="text-danger">*</span></label>
...
<script type="application/javascript">
    'use strict';
    const URL = "{{route('district.index')}}";
    ...
    $("#inlineModal").on("hidden.bs.modal", function(e) {
        ...
        $(".custom-error").html("");
        // $("#name-error").html("");
        $("#exampleModalTitle").html("Add District");
    });

    $(document).on('click', '.edit', function() {
        var id = $(this).data('id');
        var url = "{{route('district.edit','id')}}".replace('id', id);
        $.ajax({
            type: "GET",
            url: url,
            dataType: 'json',
            ...
            success: function(data) {
                if (data.msg_type == "success") {
                    $("#exampleModalTitle").html("Edit district");
                    $("#name").val(data.result.name);
                    $("#state_id").val(data.result.state_id);
                    $("#district_id").val(id);
