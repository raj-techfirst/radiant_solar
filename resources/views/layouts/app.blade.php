    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow expanded" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @endcan
                @canany(['reports-total-collection','reports-payment-pending','reports-meter-charges','reports-dispach','reports-installation','reports-meter-application','reports-final','reports-invoice','inverters-required-reports','panels-required-reports','b2b-accept','b2b-dispatch','b2b-rate','sales-agent-wise-report'])
