...
<div class="row">
    <div class="col-12 mb-1">
        <h4 class="content-header-title float-start">{{ __('message.View City') }}</h4>
        @can('city-add')
        <a role="button" class="btn btn-sm btn-primary float-end" href="{{route('city.create')}}"><i class="fa fa-plus me-25"></i> {{ __('message.Add New') }}</a>
        @endcan
    </div>
    <div class="col-12">
        <div class="card p-1">
            <table id="city" class="datatables-basic table table-hover">
                <thead>
                    <tr>
                        <th>#</th>
