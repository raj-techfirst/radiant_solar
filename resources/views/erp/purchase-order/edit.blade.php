    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-1">
                <form id="form" class="form p-0 form-repeater" method="post" action="{{ route('purchase-order.update',$purchaseOrder->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group custom-input-group">
                                        ...
                                        <input class="form-control" name="shipping_name" id="shipping_name" value="{{(isset($purchaseOrder)) ? $purchaseOrder->shipping_name : old('shipping_name')}}">
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group custom-input-group">
                                        <label class="form-label" for="shipping_mobile">Mobile</label>
                                        <input class="form-control" name="shipping_mobile" id="shipping_mobile" value="{{(isset($purchaseOrder)) ? $purchaseOrder->shipping_mobile : old('shipping_mobile')}}">
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group custom-input-group">
                                        <label class="form-label" for="shipping_email">Email</label>
                                        <input class="form-control" name="shipping_email" id="shipping_email" value="{{(isset($purchaseOrder)) ? $purchaseOrder->shipping_email : old('shipping_email')}}">
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group custom-input-group">
                                        ...
                                        <textarea rows="3" class="form-control" name="shipping_address" id="shipping_address">{{(isset($purchaseOrder)) ? $purchaseOrder->shipping_address : old('shipping_address')}}</textarea>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group custom-input-group">
                                        <label class="form-label" for="shipping_gst">GSTIN</label>
                                        <input class="form-control" name="shipping_gst" id="shipping_gst" value="{{(isset($purchaseOrder)) ? $purchaseOrder->shipping_gst : old('shipping_gst')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
