...
<div class="row">
    <div class="col-12 mb-50">
        <h4 class="content-header-title float-start">Stock Adjustment List</h4>
        @can('warehouse-stock-adjust-create')
        <a role="button" class="btn btn-sm btn-primary float-end" href="{{route('stock-adjustments.create')}}"><i class="fa fa-plus me-25"></i> Add New</a>
        @endcan
    </div>
    <div class="col-12">
        <div class="card p-1">
...
<script type="application/javascript">
    'use strict';
    const URL = "{{route('stock-adjustments.index')}}";
