...
<div class="row">
    <div class="col-12 mb-50">
        <h4 class="content-header-title float-start">Goods Issue List</h4>
        @can('delivery-challan-create')
        <a href="{{ route('delivery-challan.create') }}" class="btn btn-sm btn-primary float-end"><i class="fa fa-plus me-25"></i> Add New</a>
        @endcan
    </div>
    <div class="col-12">
        <div class="card p-1">
...
<script type="application/javascript">
    'use strict';
    const URL = "{{route('delivery-challan.index')}}";
    ...
    $(document).on('click', '.view', function() {
        $('.modal').modal('hide');
        var id = $(this).data('id');
        var url = "{{route('delivery-challan.show','id')}}".replace('id', id);
        $.ajax({
            type: "GET",
            url: url,
            data: {
