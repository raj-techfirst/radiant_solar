            ...
            <div class="card-body p-1">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        <h5><b>Date : </b> {{date('d-m-Y',strtotime($data->challan_date))}} </h5>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 form-group mt-1">
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered" id="purchaseTable">
                                ...
                                <tbody>
                                    @php $i = 0; @endphp
                                    @foreach($data->delivery_challan_meta as $key => $value)
...
<script type="application/javascript">
    ...
    $(document).on('click', '.upload', function() {
        ...
        $.ajax({
            url: "{{ route('import-serial-number-store') }}",
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('click', '.download', function() {
        var dataId = $(this).data('id');
        $.ajax({
            url: "{{route('download-serial-number-dc')}}",
            type: 'POST',
            datatype: 'json',
            data: {
                "id": dataId,
    ...
    $(document).on('click', '.view', function() {
        var dataId = $(this).data('id');
        $.ajax({
            url: "{{route('view-serial-number-dc')}}",
            type: 'POST',
            datatype: 'json',
            data: {
                "id": dataId,
