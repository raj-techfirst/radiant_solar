            ...
            <div class="auth-inner my-2">
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <h4 class="card-title my-1">Reset Password 🔒</h4>
                        <p class="card-text mb-1">for {{ session()->get('forgetPassEmail') }}</p>
                        <form id="form" class="form form-horizontal" action="javascript:void(0);" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary w-100 save" tabindex="4">Reset Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.server_error && response.status == false) {
                        ...
                        toastr.warning("Credential something wrong.", "{{ __('message.Warning') }}");
                    } else {
                        $('#form')[0].reset();
